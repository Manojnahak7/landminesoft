      ...
      <div className="lm-footer-inner">
        ...
        <div className="lm-footer-right">
          ...
          <div className="lm-social-icons">
            {/* LinkedIn */}
            <a
              href="https://linkedin.com/company/landminesoft"
              target="_blank"
            ...
            >
              ...
              >
                <path d="M0 1.146C0 .513.526 0 1.175 
                  ...
                  1.248zm4.908 8.212V9.359c0-.203.015-.406.074-.552.163-.406.535-.826 
                  1.16-.826.819 0 1.146.623 1.146 1.536v3.877h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 
                  0-1.845.7-2.165 1.193v.025h-.016l.016-.025V6.169H6.651c.03.678 
                  0 7.225 0 7.225z" />
              </svg>
            </a>
            ...
            {/* Facebook */}
            <a
              href="https://facebook.com/landminesoft"
              target="_blank"
              rel="noopener noreferrer"
              className="lm-social-link"
              aria-label="Facebook"
            >
              <svg
                ...
                viewBox="0 0 16 16"
              >
                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05-4.418 
                  0-8 3.604-8 8.05C0 11.993 2.925 15.3 6.75 
                  16v-5.624H4.719V8.05H6.75V6.275c0-2.02 
                  1.195-3.131 3.022-3.131.876 0 1.791.157 
                  1.791.157v1.98H10.83c-1.118 0-1.466.695-1.466 
                  1.408v1.361h2.494l-.399 2.326H9.364V16C13.089 
                  15.3 16 11.993 16 8.049z" />
              </svg>
            </a>

            {/* Instagram */}
            <a
              href="https://instagram.com/landminesoft"
              target="_blank"
              rel="noopener noreferrer"
              className="lm-social-link"
            ...
            >
              ...
              >
                <path d="M8 0C5.829 0 5.556.01 4.703.048 3.85.088 3.269.222 2.76.42a3.9 
                  3.9 0 0 0-1.417.923A3.9 3.9 0 0 0 .42 2.76C.222 
                  3.268.087 3.85.048 4.7.01 5.555 0 5.827 0 
                  8.001c0 2.172.01 2.444.048 3.297.04.852.174 1.433.372 
                  ...
                  1-.599.919c-.28.28-.546.453-.92.598-.28.11-.704.24-1.485.276-.843.038-1.096.047-3.232.047s-2.39-.009-3.233-.047c-.78-.036-1.203-.166-1.485-.276a2.5 
                  2.5 0 0 1-.92-.598 2.5 2.5 0 0 1-.6-.92c-.109-.281-.24-.705-.275-1.485-.038-.843-.046-1.096-.046-3.233s.008-2.388.046-3.231c.036-.78.166-1.204.276-1.486.145-.373.319-.64.599-.92s.546-.453.92-.598c.282-.11.705-.24 1.485-.276.738-.034 1.024-.044 2.515-.045zm4.988 
            ...
            >
              ...
              >
                <path d="M12.6.75h2.454l-5.36 6.142L16 
                  ...
                  5.07H.316l5.733-6.57L0 
                  .75h5.063l3.495 4.633L12.601.75Zm-.86 
